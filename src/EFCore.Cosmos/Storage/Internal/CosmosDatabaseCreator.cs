...
namespace Microsoft.EntityFrameworkCore.Cosmos.Storage.Internal
{
    public class CosmosDatabaseCreator : IDatabaseCreator
    {
        ...
        public CosmosDatabaseCreator(CosmosClient cosmosClient, IModel model)
        {
        ...
        public bool EnsureCreated()
        {
            ...
            foreach (var collection in _model.GetEntityTypes().Select(et => et.Cosmos().ContainerName).Distinct())
            {
